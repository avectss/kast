...
var Text = exports["default"] = /*#__PURE__*/(0, _createClass2["default"])(function Text() {
  ...
  this.offsetX = Number.isFinite(this.options.offsetX) ? Number(this.options.offsetX) : 0;
  this.offsetY = Number.isFinite(this.options.offsetY) ? Number(this.options.offsetY) : 0;
